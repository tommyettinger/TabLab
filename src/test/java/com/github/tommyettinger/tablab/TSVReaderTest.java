...
public class TSVReaderTest {
    ...
    private final String jobsWithFloat = "name\tdescription\toffense:f\tdefense:long\ttalents:Talent[;;]\tfavorite:Talent\tskills:str{,}f\n" +
            "Abjurer\tA defensive mage\t1\t9\tHaze;;Warding Tome\tHaze\tMist Shackles,1,Barricade,2.,Stony Shield,3.3,Body of Iron,.4\n" +
            "Brute\tA hulking bruiser\t10.000\t\tDestruction\tDestruction\t\n" +
            "Ninja\tA nimble assassin\t9E+1\t-1\tPoison;;Martial Arts\tMartial Arts\tVanish,2.0,Smoke Bomb,1.123,Shadow Dagger,2.01010101\n";
